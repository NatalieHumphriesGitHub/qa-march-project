...
app.config['SQLALCHEMY_DATABASE_URI'] = getenv('db_uri')        #this configures you to your local database - rather than the large SQL server - we will change this to connect for deployment - see notes on gsheet about connecting
